...
See the [vignette](rdhonest_stata_vignette.html) for a description of the package, and the package manual available through `help rdhonest` once the package is installed.
